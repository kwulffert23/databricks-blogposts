...
# Adjust table path to your own path if loading results from a delta table
# table_path = "kyra_wulffert.anomaly_detection.pca_anomaly_detection_synthetic_data"
# spark_df = spark.table(table_path)
# df = spark_df.toPandas()

# COMMAND ----------

# Load csv with anomaly detection output usingthe PCA model in notebook 1
df = pd.read_csv('./data/pca_anomaly_detection_synthetic_data.csv')
