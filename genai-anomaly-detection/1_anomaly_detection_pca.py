...
import pandas as pd
df = pd.read_csv('./data/purchase_vendors_products_synthetic.csv')
...
# Saving results as a csv to load in the next notebook
df_with_anomalies_all.to_csv('./data/pca_anomaly_detection_synthetic_data.csv', index=False)
